...
//
// This package is inspired by and adapted from the github-mcp-server project:
// https://github.com/modelcontextprotocol/servers/tree/main/src/github-mcp-server
//
// Original work Copyright (c) 2025 GitHub
...
//
// Behavior:
//   - If UPDATE_TOOLSNAPS environment variable is set to "true", it updates the snapshot file
...
func Test(toolName string, tool any) error {
	...
	if err != nil {
		return fmt.Errorf("failed to read snapshot file for %s: %w", toolName, err)
	}
